...
7. Missing or mismatched evidence becomes stale, split, legacy/restart-required, or ambiguous and controls fail closed. Exact unit and private target absence plus a safely absent or exactly verified marker may stale-clean; partial presence and probe errors are ambiguous. Existing shared sessions remain unverified and are never retroactively claimed.
